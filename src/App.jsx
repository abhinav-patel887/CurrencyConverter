...
function App() {
  ...
  const convert=()=>(
    setConverted(Math.round(amount*currencyInfo[to]*100)/100)
  )
  return (
    <div className='w-full h-screen flex flex-wrap justify-center 
    items-center bg-cover bg-no-repeat '
      style={{backgroundImage: 'url(https://media.istockphoto.com/id/1369016743/vector/stock-market-information-background-with-numbers-indexes-chart-and-diagrams-abstract-trading.jpg?s=612x612&w=0&k=20&c=hP1Qmx0R_Xgj28hCFlSHXTvBQcad037ZYYmVDdmtvSU='}}
      >
